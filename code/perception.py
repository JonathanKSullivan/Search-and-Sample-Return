...
def perception_step(Rover):
    ...
    print("3")
    warped_obstacles_bin_img = color_thresh(warped_img, rgb_thresh=(27, 22, 19))
    warped_rock_bin_img = color_thresh(warped_img, rgb_thresh=(250, 250, 100))
    warped_terrain_bin_img = color_thresh(warped_img, rgb_thresh=(159,141,129))
    # 4) Update Rover.vision_image (this will be displayed on left side of screen)
        # Example: Rover.vision_image[:,:,0] = obstacle color-thresholded binary image
        #          Rover.vision_image[:,:,1] = rock_sample color-thresholded binary image
        #          Rover.vision_image[:,:,2] = navigable terrain color-thresholded binary image
    print("4")
    Rover.vision_image[:,:,0] = warped_obstacles_bin_img
    Rover.vision_image[:,:,1] = warped_rock_bin_img
    Rover.vision_image[:,:,2] = warped_terrain_bin_img
